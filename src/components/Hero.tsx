  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-black">
      ...
      >
        ...
        >
          <div className="flex items-center justify-between">
            ...
            >
              <span className="font-bagel text-white text-xl tracking-wider">ALOSAIMI CONSULTING</span>
            </motion.div>
      ...
      <motion.div
        ...
        className="absolute bottom-24 left-6 sm:left-8 lg:left-12 z-40"
      >
      ...
      <motion.div
        ...
        className="fixed bottom-0 left-0 right-0 w-full z-[120] bg-black/90 backdrop-blur-sm border-t border-white/10"
      >
        <div className="flex items-center justify-between px-6 sm:px-8 lg:px-12 py-3 w-full max-w-[95vw] mx-auto">
          {/* Distribute words across the bar */}
          <span className="text-white/80 text-xs sm:text-sm md:text-base font-medium uppercase tracking-widest">A</span>
          <span className="text-white/80 text-xs sm:text-sm md:text-base font-medium uppercase tracking-widest">FOUNDATION</span>
          <span className="text-white/80 text-xs sm:text-sm md:text-base font-medium uppercase tracking-widest">OF</span>
          <span className="text-white/80 text-xs sm:text-sm md:text-base font-medium uppercase tracking-widest">TRUST</span>
        </div>
      </motion.div>
